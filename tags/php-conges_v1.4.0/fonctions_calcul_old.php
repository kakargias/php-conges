...
{	
	...
	{
		// On ne peut pas calculer si, pour l'année considérée, les jours feries n'ont pas ete saisis
...
// renvoit le jour precedent de la date paséée en paramètre sous la forme yyyy-mm-jj
