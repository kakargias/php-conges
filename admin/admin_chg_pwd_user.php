...
<?php 
	...
	if($u_login!="") {
		echo "<H1>Modification Password utilisateur : $u_login .</H1>\n\n";
		modifier($u_login, $DEBUG);
	}
	else {
		if($u_login_to_update!="") {
			echo "<H1>Modification Password utilisateur : $u_login_to_update .</H1>\n\n";
...
function modifier($u_login, $DEBUG=FALSE)
{
	...
	echo "<tr align=\"center\"><td class=\"histo\">login</td><td class=\"histo\">Nom</td><td class=\"histo\">Prenom</td><td class=\"histo\">password1</td><td class=\"histo\">password2</td></tr>\n";
