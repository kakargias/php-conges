...
$LANG['resp_menu_button_ajout_jours']		= "Añadir Dias Vacaciones";
...
$LANG['resp_ajout_conges_nb_jours_ajout']		= "N° dias a añadir";
...
$LANG['config_abs_add_type_abs_comment']	= "Entrar el tipo de ausencia que Ud. quiere añadir :";
...
$LANG['14_Présentation']			= "14 Presentacion";
...
$LANG['config_comment_where_to_find_user_email']		= "//  DONDE ENCONTRAR LAS DIRECCIONES MAILS DE LOS USUARIOS<br>\n//-------------------------------------------------<br>\n// varias posibilidades para encontrar las direcciones mails de los usuarios :<br>\n// si à \"dbconges\" : el mail de los user se encuentra dentro de la tabla users de la database db_vacaciones<br>\n// si à \"ldap\"     : el mail de los user se encuentra dentro de un anuario LDAP que vamos a interrogar (cf fichero config_ldap.php)<br>\n// ATENCION : todo otro valor que \"dbconges\" o \"ldap\" comportara une érreur !!!";
...
$LANG['button_export_2']			= "button_export_2";   //"Exporter les évenements au format ical / vcal";
