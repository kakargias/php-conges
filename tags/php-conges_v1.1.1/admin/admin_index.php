...
echo "</head>\n";
	...
	if($_SESSION['config']['affiche_bouton_config_pour_admin']==TRUE)
	{
		...
		echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('../install/configure.php?session=$session','mapage',800,600);\">\n";
		echo " <img src=\"../img/tux_config_32x32.png\" width=\"32\" height=\"32\" border=\"0\" title=\"".$_SESSION['lang']['admin_button_config_1']."\" alt=\"".$_SESSION['lang']['admin_button_config_1']."\">\n";
		echo " </a>\n";
	...
	if($_SESSION['config']['affiche_bouton_config_absence_pour_admin']==TRUE)
	{
		...
		echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('../install/config_type_absence.php?session=$session','mapage',800,600);\">\n";
		echo " <img src=\"../img/tux_config_32x32.png\" width=\"32\" height=\"32\" border=\"0\" title=\"".$_SESSION['lang']['admin_button_config_abs_1']."\" alt=\"".$_SESSION['lang']['admin_button_config_abs_1']."\">\n";
		echo " </a>\n";
	...
	echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('admin_jours_chomes.php?session=$session','mapage',1080,625);\">\n";
	...
	echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('admin_db_sauve.php?session=$session','mapage',400,300);\">\n";
...
//		|| strlen($tab_new_user['solde_jours'])==0 
		|| $tab_new_user['quotite']>100) ) )
	{
		...
		if ($num_verif!=0)
		{
			echo "<H3> ".$_SESSION['lang']['admin_verif_login_exist']." </H3>\n"  ;
			echo "<form action=\"$PHP_SELF?session=$session\" method=\"POST\">\n"  ;
			echo "<input type=\"hidden\" name=\"new_login\" value=\"".$tab_new_user['login']."\">\n";
			echo "<input type=\"hidden\" name=\"new_nom\" value=\"".$tab_new_user['nom']."\">\n";
			echo "<input type=\"hidden\" name=\"new_prenom\" value=\"".$tab_new_user['prenom']."\">\n";
...
function affiche_gestion_utilisateurs($mysql_link, $DEBUG=FALSE)
{
	...
	{
		echo "<td class=\"titre\">$libelle / ".$_SESSION['lang']['divers_annee']."</td>\n";
...
function affiche_gestion_responsable_groupes($choix_resp, $mysql_link, $DEBUG=FALSE)
{
	...
	// affichage TITRE
	echo "<tr align=\"center\">\n";
	echo "	<td colspan=3><h3>".$_SESSION['lang']['admin_gestion_groupe_resp_groupes']." $sql_prenom $sql_nom</h3></td>\n";
	echo "</tr>\n";
	echo "<tr align=\"center\">\n";
	echo "	<td class=\"titre\">&nbsp;</td>\n";
	echo "	<td class=\"titre\">&nbsp;".$_SESSION['lang']['admin_groupes_groupe']."&nbsp;:</td>\n";
