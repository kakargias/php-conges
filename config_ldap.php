...
/**   LDAP classique type OpenLDAP    **/
$config_ldap_server = "ldap://localhost";
$config_ldap_bupsvr = "";
$config_basedn      = "dc=univ-montp2,dc=fr";
$config_ldap_user   = "";
$config_ldap_pass   = "";
$config_searchdn    = "ou=people,dc=univ-montp2,dc=fr";

$config_ldap_prenom = "cn"; 
$config_ldap_nom    = "sn";
$config_ldap_mail   = "mail";
$config_ldap_login  = "uid";
$config_ldap_nomaff = "gecos";
//$config_ldap_filtre = "eduPersonAffiliation";
//$config_ldap_filrech= "member";
//$config_ldap_filtre = "supannAffectation";
//$config_ldap_filrech= "Scienc*";
$config_ldap_filtre = "";
$config_ldap_filrech= "";

// filtre optionel : Si ce filtre_complet est renseigné, il sera utilisé, sinon les filtres $config_ldap_filtre et 
// $config_ldap_filrech seront utilisés.
$config_ldap_filtre_complet = "(uid=*)";   
//$config_ldap_filtre_complet = "(&(displayName=*)(|(supannAffectation=Scienc*)(supannAffectation=DROIT)))";   
