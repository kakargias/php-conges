...
$config_php_conges_version="1.0.1";
...
$config_titre_page_accueil="PHP_CONGES V1.0.1";           // Titre de la page d'accueil de php_conges
...
//  REMPLISSAGE AUTOMATIQUE DU CHAMP LORS DE L'APPEL AU CALCUL DU NB DE JOURS PRIS
//--------------------------------------------------------------------------------------
// si à FALSE : l'appel au bouton de calcul du nb de jours pris ne rempli pas automatiquement le champ du formulaire (saisi à la main) (FALSE est la valeur par defaut)
// si à TRUE : l'appel au bouton de calcul du nb de jours pris rempli automatiquement le champ du formulaire 
$config_rempli_auto_champ_nb_jours_pris = FALSE ;
