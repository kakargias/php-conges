...
echo "</head>\n";
	...
	{
		echo "<td width=\"80\" align=\"center\" valign=\"top\">\n";
		echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('../install/config_mail.php?session=$session','mapage',800,600);\">\n";
...
function ajout_groupe($new_group_name, $new_group_libelle, $new_group_double_valid, $mysql_link, $DEBUG=FALSE)
{
	...
	if(verif_new_param_group($new_group_name, $new_group_libelle, $mysql_link, $DEBUGg_double_valid)==0)  // verif si les nouvelles valeurs sont coohérentes et n'existe pas déjà 
	{
