...
function affiche_choix_gestion_groupes_users($choix_group, $choix_user, $mysql_link)
{
	...
	if( (isset($choix_group)) && ($choix_group!="") )     // si un groupe choisi : on affiche la gestion par groupe
	{
		affiche_gestion_groupes_users($choix_group, $mysql_link);
	}
	elseif( (isset($choix_user)) && ($choix_user!="") )     // si un user choisi : on affiche la gestion par user
	{
...
function affiche_choix_gestion_groupes_responsables($choix_group, $choix_resp, $mysql_link)
{
	...
	elseif( (isset($choix_resp)) && ($choix_resp!="") )     // si un resp choisi : on affiche la gestion par resp
	{
