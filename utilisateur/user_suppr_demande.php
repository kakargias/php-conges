...
defined( '_PHP_CONGES' ) or die( 'Restricted access' );
	...
	// TITRE
	echo '<div class="nouvelle_absence" id="sup_dmd">';
...
function confirmer($p_num, $onglet, $DEBUG=FALSE)
{
	...
	echo '<table  id="dmd_sup" width=\"80%\">';
	echo "<thead>\n";
...
function suppression($p_num_to_delete, $onglet, $DEBUG=FALSE)
{
	...
	// echo ;
	if($result_delete)
		echo  '<div style="width:30%;" id="confirm_sup_dmd" class="ui-state-highlight ui-corner-all" style="padding: 0 .7em;"><span class="ui-icon ui-icon-circle-check" style="float:left;"></span>'._('form_modif_ok') ."<br><br> \n";
	else
		echo  '<div style="width:30%;" id="confirm_sup_dmd" class="ui-state-error ui-corner-all" style="padding: 0 .7em;"><span class="ui-icon ui-icon-alert" style="float: left; margin-right: .3em;">'. _('form_modif_not_ok') ."<br><br> \n";
	echo '</div>';
