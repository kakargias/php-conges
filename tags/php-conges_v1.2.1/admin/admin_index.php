...
echo "</head>\n";
	...
	if($_SESSION['config']['affiche_bouton_config_pour_admin']==TRUE)
	{
		...
		echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('../config/configure.php?session=$session','mapage',800,600);\">\n";
	...
	if($_SESSION['config']['affiche_bouton_config_absence_pour_admin']==TRUE)
	{
		...
		echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('../config/config_type_absence.php?session=$session','mapage',800,600);\">\n";
	...
	{
		echo "<td width=\"80\" align=\"center\" valign=\"top\">\n";
		echo " <a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('../config/config_mail.php?session=$session','mapage',800,600);\">\n";
