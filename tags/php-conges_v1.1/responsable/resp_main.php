...
<?php 
	...
	$ReqLog1 = mysql_query($sql1, $mysql_link) or die("ERREUR : user_main.php : ".mysql_error());
	...
	echo "<tr align=\"center\"><td class=\"titre\">NOM</td><td class=\"titre\">PRENOM</td><td class=\"titre\">Quotité</td>" ;
	...
	{		
		...
		$text_affich_user="<a href=\"resp_traite_user.php?session=$session&user_login=$current_login\">Afficher</a>" ;
		$text_edit_papier="<a href=\"../edition/edit_user.php?session=$session&user_login=$current_login\" target=\"_blank\">Edition Papier</a>";
