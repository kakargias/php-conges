...
function affichage($tab_new_values, $mysql_link, $session, $DEBUG=FALSE)
{
	...
	while ($data = mysql_fetch_array($ReqLog1)) 
	{
		...
		echo "    	<td class=\"config\"><i>".$_SESSION['lang']['mail_remplace_url_accueil_comment']."<br>".$_SESSION['lang']['mail_remplace_sender_name_comment']."<br>".$_SESSION['lang']['mail_remplace_destination_name_comment']."<br>".$_SESSION['lang']['mail_remplace_retour_ligne_comment']."</i></td>\n";
		echo "    </tr>\n";
