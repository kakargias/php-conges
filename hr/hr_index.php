...
function page_principale($session, $tab_type_cong, $tab_type_conges_exceptionnels, $DEBUG)
{
    ...
    echo "<H2>".$_SESSION['lang']['hr_traite_user_etat_conges']."</H2>\n\n";
    ...
    else
    {
        ...
        {        
            ...
            $text_affich_user="<a href=\"hr_index.php?session=$session&onglet=hr_traite_user&user_login=$current_login\">".$_SESSION['lang']['resp_etat_users_afficher']."</a>" ;
