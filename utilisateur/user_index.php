...
// verifie les parametre de le nouvelle demande :si ok : enregistre la demande dans rable conges_periode
...
//$DEBUG=TRUE;
	...
	if($valid==TRUE)
	{
		...
		$periode_num=insert_dans_periode($_SESSION['userlogin'], $new_debut, $new_demi_jour_deb, $new_fin, $new_demi_jour_fin, $new_nb_jours, $new_comment, $new_type, $new_etat, $mysql_link, $DEBUG);
