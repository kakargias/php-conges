...
echo "</head>\n";
	...
	{
		commit_update($group_to_update, $new_groupname, $new_comment, $mysql_link, $DEBUG);
	}
	else 
	{
...
function commit_update($group_to_update, $new_groupname, $new_comment, $mysql_link, $DEBUG=FALSE)
{
	$PHP_SELF=$_SERVER['PHP_SELF'];
	$session=session_id();
