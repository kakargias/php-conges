...
//	echo "   <h3>$nom_mois  $year</h3>\n";
	...
	affichage_calendrier($year, $mois, $first_jour, $timestamp_today, $printable, $page_initiale, $selected, $tab_type_absence, $DEBUG);
...
// AFFICHAGE  TABLEAU (CALENDRIER)
function affichage_calendrier($year, $mois, $first_jour, $timestamp_today, $printable, $page_initiale, $selected, $tab_type_absence, $DEBUG=FALSE)
{
	$PHP_SELF=$_SERVER['PHP_SELF'];
	$session=session_id();
