...
function suppression($u_login_to_delete) {
	...
	$result4 = mysql_query($sql4, $link) or die("ERREUR : mysql_query : ".$sql4." --> ".mysql_error()) ;
	
	$sql5 = "DELETE FROM conges_groupe_resp WHERE gr_login = '$u_login_to_delete' " ;
	$result5 = mysql_query($sql5, $link) or die("ERREUR : mysql_query : ".$sql5." --> ".mysql_error()) ;
	
	$sql6 = "DELETE FROM conges_groupe_users WHERE gu_login = '$u_login_to_delete' " ;
	$result6 = mysql_query($sql6, $link) or die("ERREUR : mysql_query : ".$sql6." --> ".mysql_error()) ;
