...
CREATE TABLE `conges_artt` (
  `a_login` varbinary(16) NOT NULL default '',
...
CREATE TABLE `conges_echange_rtt` (
  `e_login` varbinary(16) NOT NULL default '',
...
CREATE TABLE `conges_edition_papier` (
  ...
  `ep_login` varbinary(16)  NOT NULL default '',
...
CREATE TABLE `conges_groupe_resp` (
  ...
  `gr_login` varbinary(16) NOT NULL default ''
) DEFAULT CHARSET=latin1;
...
CREATE TABLE `conges_groupe_grd_resp` (
  ...
  `ggr_login` varbinary(16) NOT NULL default ''
) DEFAULT CHARSET=latin1;
...
CREATE TABLE `conges_groupe_users` (
  ...
  `gu_login` varbinary(16) NOT NULL default ''
) DEFAULT CHARSET=latin1;
...
CREATE TABLE `conges_periode` (
  `p_login` varbinary(16) NOT NULL default '',
...
INSERT INTO `conges_config` VALUES ('URL_ACCUEIL_CONGES', 'http://mon-serveur/mon-chemin/php_conges_v1.1.2', '01_Serveur Web', 'texte', 'config_comment_URL_ACCUEIL_CONGES');
...
INSERT INTO `conges_config` VALUES ('stylesheet_file', 'style_basic.css', '14_Presentation', 'texte', 'config_comment_stylesheet_file');
...
INSERT INTO `conges_config` VALUES ('temps_partiel_bgcolor', '#FFFFC4', '14_Presentation', 'hidden', 'config_comment_temps_partiel_bgcolor');
...
CREATE TABLE `conges_solde_user` (
  `su_login` varbinary(16) NOT NULL default '',
...
#
# Structure de la table `conges_historique_ajout`
#

CREATE TABLE `conges_historique_ajout`(
`ha_login` varbinary(16) NOT NULL ,
...
CREATE TABLE `conges_logs` (
   ...
   `log_user_login_par` varbinary(16) NOT NULL default '', 
   `log_user_login_pour` varbinary(16) NOT NULL default '', 
