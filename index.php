...
if(isset($session_username))
{
	...
	//session_username=$login;
		...
		// OU on est en mode "responsable virtuel" avec login= celui du resp virtue
		if ( (($row["u_is_resp"]=="Y")&&($config_responsable_virtuel==0)) || (($config_responsable_virtuel==1)&&($session_username=="conges")) )
		{
