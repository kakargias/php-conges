...
global $config_responsable_virtuel ;
	...
	if($config_responsable_virtuel==FALSE)
		$sql = "SELECT u_login, u_nom, u_prenom, u_nb_jours_an, u_solde_jours FROM conges_users WHERE u_resp_login = '$session_username' ORDER BY u_nom";
	else
		$sql = "SELECT u_login, u_nom, u_prenom, u_nb_jours_an, u_solde_jours FROM conges_users WHERE u_login != 'conges' ORDER BY u_nom";
