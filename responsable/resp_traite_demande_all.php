...
function saisie($mysql_link, $DEBUG) 
{
	$PHP_SELF=$_SERVER['PHP_SELF'];
	$session=session_id() ;
	...
	else
	{
		...
		echo "<td class=\"titre\">Debut</td><td class=\"titre\">Fin</td><td class=\"titre\">Commentaire</td><td class=\"titre\">nb Jours<br>Pris</td>";
		foreach($tab_type_conges as $id_conges => $libelle)
		{
			echo "<td class=\"titre\">Solde<br>$libelle</td>" ;
		}
		echo "<td class=\"titre\">Type</td><td class=\"titre\">Accepter</td><td class=\"titre\">Refuser</td><td class=\"titre\">Attente</td><td class=\"titre\">Motif<br>de refus</td>\n" ;
		echo "</tr>\n";
...
function traite_demande($mysql_link, $tab_bt_radio, $tab_text_refus, $DEBUG) 
{
	$PHP_SELF=$_SERVER['PHP_SELF'];
	$session=session_id();
