...
// verif si les resp peuvent ajouter des conges
if($_SESSION['config']['resp_ajoute_conges']==FALSE)
{
	//INTERDIT ! 
	// on delete la session et on renvoit sur l'authentification (page d'accueil)
	session_delete($session);
	echo "<META HTTP-EQUIV=REFRESH CONTENT=\"0; URL=".$_SESSION['config']['URL_ACCUEIL_CONGES']."\">";
	exit;
}
