...
//---------------------------------------
// si à FALSE : dans la fenetre responsable, le menu est vertical (à gauche) (FALSE est la valeur par defaut)
// si à TRUE : dans la fenetre responsable, le menu est horizontal (en haut)
