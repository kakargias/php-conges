...
function affichage_calendrier($year, $mois, $first_jour, $jour_today, $printable, $page_initiale, $selected, $tab_type_absence, $DEBUG=FALSE)
{
	...
	$session=session_id();
		...
		echo "	<td class=\"cal-user\">NOM</td><td class=\"cal-user\">PRENOM</td><td class=\"cal-user\">%</td>";
		// affichade des libellé des conges
		foreach($tab_type_cong as $id => $libelle)
		{
				echo "<td class=\"cal-user\">solde $libelle</td>";
		}
...
//	echo "         <td bgcolor=\"".$_SESSION['config']['temps_partiel_bgcolor']."\" class=\"cal-legende\">abs</td>\n" ;
	...
	echo "         <td class=\"cal-legende\"> absence hebdomadaire (temps partiel , RTT)</td>\n" ;
	echo "      </tr>\n" ;
	echo "      <tr align=\"center\">\n" ;
