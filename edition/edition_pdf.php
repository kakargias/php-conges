	...
	else
	{
		...
		/*********************************************/
			...
			else
			{
				...
				{
					affiche_tableau_conges_avec_date_traitement($pdf, $ReqLog2, $decalage, $tab_type_cong, $DEBUG);
				}
				else
				{
					affiche_tableau_conges_normal($pdf, $ReqLog2, $decalage, $tab_type_cong, $DEBUG);
				}
...
function affiche_tableau_conges_avec_date_traitement(&$pdf, $ReqLog2, $decalage, $tab_type_cong, $DEBUG=FALSE)
{
	...
	while ($resultat2 = mysql_fetch_array($ReqLog2)) 
	{
		...
		$pdf->Cell($size_cell_type, $hauteur_cellule*2, $tab_type_cong[$sql_p_type], 1, 0, 'C'); 
...
function affiche_tableau_conges_normal(&$pdf, $ReqLog2, $decalage, $DEBUG=FALSE)
{
	...
	while ($resultat2 = mysql_fetch_array($ReqLog2)) 
	{
		...
		$pdf->Cell($size_cell_type, $hauteur_cellule, $tab_type_cong[$sql_p_type], 1, 0, 'C'); 
