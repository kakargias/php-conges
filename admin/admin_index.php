...
echo "</head>\n";
	...
	if($saisie_user=="ok") 
	{
		if($_SESSION['config']['export_users_from_ldap'] == TRUE)
		{
			...
			{
				ajout_user($tab_new_user[$login], $tab_checkbox_sem_imp, $tab_checkbox_sem_p, $tab_new_jours_an, $tab_new_solde, $mysql_link, $DEBUG);
			}
		}
		else
			ajout_user($tab_new_user[0], $tab_checkbox_sem_imp, $tab_checkbox_sem_p, $tab_new_jours_an, $tab_new_solde, $mysql_link, $DEBUG);
	}
