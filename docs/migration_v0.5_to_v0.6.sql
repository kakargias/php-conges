...
ALTER TABLE `conges_periode` ADD `p_demi_jour_deb` enum('am','pm') NOT NULL default 'am';
ALTER TABLE `conges_periode` ADD   `p_demi_jour_fin` enum('am','pm') NOT NULL default 'pm';
