...
function compter($user, $num_current_periode, $date_debut, $date_fin, $opt_debut, $opt_fin, &$comment,  $DEBUG=true, $num_update = null)
{
...
function verif_jours_feries_saisis($date,  $DEBUG=true)
{
...
function make_tab_demi_jours_periode($date_debut, $date_fin, $opt_debut, $opt_fin, $DEBUG=true)
{
...
function verif_periode_chevauche_periode_user($date_debut, $date_fin, $user, $num_current_periode='', $tab_periode_calcul, &$comment, $DEBUG=true, $num_update = null)
{
		/************************************************************/
		// 2 : on verifie que le conges demandé ne chevauche pas une periode deja posée
