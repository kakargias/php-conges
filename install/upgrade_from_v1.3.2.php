...
function e1_insert_into_conges_config( $DEBUG=FALSE)
{
	...
	$result_insert_1 = $sql->query($sql_insert_1) or die("erreur : e1_insert_into_conges_config<br>\n".$sql->error) ;
	...
	$result_insert_2 = $sql->query($sql_insert_2) or die("erreur : e1_insert_into_conges_config<br>\n".$sql->error) ;
	...
	$result_insert_3 = $sql->query($sql_insert_3) or die("erreur : e1_insert_into_conges_config<br>\n".$sql->error) ;
	...
	$result_insert_4 = $sql->query($sql_insert_4) or die("erreur : e1_insert_into_conges_config<br>\n".$sql->error) ;
...
function e2_create_table_jours_fermeture( $DEBUG=FALSE)
{
	...
	if($DEBUG==FALSE)
		...
		$result_create = $sql->query($sql_create) or die("erreur : e2_create_table_jours_fermeture<br>\n".$sql->error) ;
...
function e3_alter_table_conges_periode( $DEBUG=FALSE)
{
	...
	$result_alter_1 = $sql->query($sql_alter_1) or die("erreur : e3_alter_table_conges_periode<br>\n".$sql->error) ;

	$sql_alter_2=" ALTER TABLE `conges_periode` CHANGE `p_nb_jours` `p_nb_jours` DECIMAL( 5, 2 ) NOT NULL DEFAULT '0.00' ";
	$result_alter_2 = $sql->query($sql_alter_2) or die("erreur : e3_alter_table_conges_periode<br>\n".$sql->error) ;
...
function e4_alter_tables_longueur_login( $DEBUG=FALSE)
{
	...
	$result_alter_1 = $sql->query($sql_alter_1) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_2=" ALTER TABLE `conges_solde_user` CHANGE `su_login` `su_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_21 = $sql->query($sql_alter_2) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_3=" ALTER TABLE `conges_periode` CHANGE `p_login` `p_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_3 = $sql->query($sql_alter_3) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;
	...
	$result_alter_4 = $sql->query($sql_alter_4) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_5=" ALTER TABLE `conges_historique_ajout` CHANGE `ha_login` `ha_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_5 = $sql->query($sql_alter_5) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_6=" ALTER TABLE `conges_groupe_users` CHANGE `gu_login` `gu_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_6 = $sql->query($sql_alter_6) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_7=" ALTER TABLE `conges_groupe_resp` CHANGE `gr_login` `gr_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_7 = $sql->query($sql_alter_7) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_8=" ALTER TABLE `conges_groupe_grd_resp` CHANGE `ggr_login` `ggr_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_8 = $sql->query($sql_alter_8) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_9=" ALTER TABLE `conges_edition_papier` CHANGE `ep_login` `ep_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_9 = $sql->query($sql_alter_9) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_10=" ALTER TABLE `conges_echange_rtt` CHANGE `e_login` `e_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_10 = $sql->query($sql_alter_10) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;

	$sql_alter_11=" ALTER TABLE `conges_artt` CHANGE `a_login` `a_login` VARBINARY( 32 ) NOT NULL ";
	$result_alter_11 = $sql->query($sql_alter_11) or die("erreur : e4_alter_tables_longueur_login<br>\n".$sql->error) ;
...
function e5_delete_from_conges_config( $DEBUG=FALSE)
{
	...
	$result_insert_1 = $sql->query($sql_insert_1) or die("erreur : e5_delete_from_conges_config<br>\n".$sql->error) ;
