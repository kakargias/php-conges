...
echo "</head>\n";
	...
	echo "<td width=\"135\" align=\"right\" valign=\"middle\">\n";
		echo "<a href=\"javascript:void(0);\" onClick=\"javascript:OpenPopUp('resp_cloture_year.php?session=$session','cloture_exercice',800,600);\">" .
		 "<img src=\"../img/reload3.png\" width=\"22\" height=\"22\" border=\"0\" title=\"".$_SESSION['lang']['button_cloture']."\" alt=\"".$_SESSION['lang']['button_calendar']."\">" .
		 "</a> ".$_SESSION['lang']['button_cloture']."\n";
	echo "</td>\n";

	/*** bouton mode utilisateur ***/ 
	echo "<td width=\"110\" align=\"right\" valign=\"middle\">\n";
...
//	if ($_SESSION['config']['gestion_conges_exceptionnels']==TRUE) 
	...
	elseif($onglet=="resp_traite_user")
	{
		...
		{
			affichage($user_login,  $year_affichage, $year_calendrier_saisie_debut, $mois_calendrier_saisie_debut, $year_calendrier_saisie_fin, $mois_calendrier_saisie_fin, $tri_date, $mysql_link, $DEBUG);
		}
	}
