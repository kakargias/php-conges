...
function session_saisie_user_password($erreur, $session_username, $session_password)
{
   $PHP_SELF=$_SERVER['PHP_SELF'];
	...
	echo "	document.write(\"<font color='#FF0000'><br><br><center>Il est n&eacute;cessaire que votre navigateur accepte les <b>cookies</b> pour pouvoir vous connecter &agrave; PHP_CONGES.</center></font><br><br>\");\n";
	echo "}\n";
	echo "//-->\n";
	echo "</script>\n";
	echo "<noscript>\n";
	echo "		<font color=\"#FF0000\"><br><br><center>Il est conseill&eacute; que votre navigateur accepte le <b>Javascript</b> pour utiliser PHP_CONGES.</center></font><br><br>\n";
	echo "</noscript>\n";
...
//		echo "<TABLE BGCOLOR='#dcdcdc' BORDER='1'>\n";
	...
	if( (isset($_SERVER["HTTP_USER_AGENT"])) && (stristr($_SERVER["HTTP_USER_AGENT"], "MSIE")!=FALSE) )
	{
		...
		echo "&nbsp;Remarque : Certains affichages peuvent ne pas être pris en charge par Microsoft IE. Utilisez plutôt Mozilla Firefox.";
		echo "</td></tr>\n";
	}
