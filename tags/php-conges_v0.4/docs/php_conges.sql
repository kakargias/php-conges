...
INSERT INTO `conges_users` (`u_login`, `u_nom`, `u_prenom`, `u_nb_jours_an`, `u_nb_jours_reste`, `u_is_resp`, `u_resp_login`, `u_passwd`, `u_quotite`) VALUES ('conges', 'conges', 'responsable-virtuel', '0.00', '0.00', 'Y', NULL, '0b7f970d6be850dc', 100);
