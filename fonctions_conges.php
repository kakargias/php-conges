...
function soustrait_solde_user($user_login, $user_nb_jours_pris, $type_abs, $mysql_link, $DEBUG=FALSE)
{
	...
	$ReqLog2 = requete_mysql($sql2,$mysql_link, "soustrait_solde_user", $DEBUG) ;				
}
*/
...
//  soustrait_solde_et_reliquat_user($user_login, $user_nb_jours_pris, $type_abs, $date_deb, $demi_jour_deb, $date_fin, $demi_jour_fin, $mysql_link, $DEBUG=FALSE)
...
*/			
function soustrait_solde_et_reliquat_user($user_login, $user_nb_jours_pris, $type_abs, $date_deb, $demi_jour_deb, $date_fin, $demi_jour_fin, $mysql_link, $DEBUG=FALSE)
{
	...
	if($_SESSION['config']['autorise_reliquats_exercice']==TRUE)
	{
		...
		if($_SESSION['config']['jour_mois_limite_reliquats']!=0)
		{
			...
			else
			{
				...
				$nb_reliquats_a_deduire = compter($user_login, $date_deb, $_SESSION['config']['date_limite_reliquats'], $demi_jour_deb, "pm", null , $mysql_link, $DEBUG);
