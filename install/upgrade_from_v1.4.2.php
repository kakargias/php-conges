...
function e1_create_table_conges_appli( $DEBUG=FALSE)
{
	...
	if($DEBUG==FALSE)
		...
		$result_create = $sql->query($sql_create) or die("erreur : e1_create_table_conges_appli<br>\n".$sql->error) ;
...
function e2_insert_into_conges_appli( $DEBUG=FALSE)
{
	...
	$result_insert_1 = $sql->query($sql_insert_1) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_2="INSERT INTO `conges_appli` VALUES ('date_limite_reliquats', '0')";
	$result_insert_2 = $sql->query($sql_insert_2) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_3="INSERT INTO `conges_appli` VALUES ('semaine_bgcolor', '#FFFFFF')";
	$result_insert_3 = $sql->query($sql_insert_3) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_4="INSERT INTO `conges_appli` VALUES ('week_end_bgcolor', '#BFBFBF')";
	$result_insert_4 = $sql->query($sql_insert_4) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_5="INSERT INTO `conges_appli` VALUES ('temps_partiel_bgcolor', '#FFFFC4')";
	$result_insert_5 = $sql->query($sql_insert_5) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_6="INSERT INTO `conges_appli` VALUES ('conges_bgcolor', '#DEDEDE')";
	$result_insert_6 = $sql->query($sql_insert_6) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_7="INSERT INTO `conges_appli` VALUES ('demande_conges_bgcolor', '#E7C4C4')";
	$result_insert_7 = $sql->query($sql_insert_7) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_8="INSERT INTO `conges_appli` VALUES ('absence_autre_bgcolor', '#D3FFB6')";
	$result_insert_8 = $sql->query($sql_insert_8) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;

	$sql_insert_9="INSERT INTO `conges_appli` VALUES ('fermeture_bgcolor', '#7B9DE6')";
	$result_insert_9 = $sql->query($sql_insert_9) or die("erreur : e2_insert_into_conges_appli<br>\n".$sql->error) ;
...
function e3_delete_from_table_conges_config( $DEBUG=FALSE)
{
	...
	$result_delete_1 = $sql->query($sql_delete_1) or die("erreur : e3_delete_from_table_conges_config<br>\n".$sql->error) ;

	$sql_delete_2="DELETE FROM conges_config WHERE conf_nom = 'rtt_comme_conges' ";
	$result_delete_2 = $sql->query($sql_delete_2) or die("erreur : e3_delete_from_table_conges_config<br>\n".$sql->error) ;
}
...
function e4_alter_table_conges_users( $DEBUG=FALSE)
{
	...
	$result_alter_1 = $sql->query($sql_alter_1) or die("erreur : e4_alter_table_conges_users<br>\n".$sql->error) ;
...
function e6_alter_table_conges_solde_user( $DEBUG=FALSE)
{
	...
	$result_alter_1 = $sql->query($sql_alter_1) or die("erreur : e6_alter_table_conges_solde_user<br>\n".$sql->error) ;
...
function e7_alter_tables_taille_login( $DEBUG=FALSE)
{
	...
	$result_alter_1 = $sql->query($sql_alter_1) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ;

	$sql_alter_2=" ALTER TABLE `conges_echange_rtt` CHANGE `e_login` `e_login` VARBINARY( 99 ) NOT NULL ";
	$result_alter_2 = $sql->query($sql_alter_2) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ; 

	$sql_alter_3=" ALTER TABLE `conges_edition_papier` CHANGE `ep_login` `ep_login` VARBINARY( 99 ) NOT NULL ";
	$result_alter_3 = $sql->query($sql_alter_3) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ; 

	$sql_alter_4=" ALTER TABLE `conges_groupe_grd_resp` CHANGE `ggr_login` `ggr_login` VARBINARY( 99 ) NOT NULL ";
	$result_alter_4 = $sql->query($sql_alter_4) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ;  

	$sql_alter_5=" ALTER TABLE `conges_groupe_resp` CHANGE `gr_login` `gr_login` VARBINARY( 99 ) NOT NULL ";
	$result_alter_5 = $sql->query($sql_alter_5) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ;

	$sql_alter_6=" ALTER TABLE `conges_groupe_users` CHANGE `gu_login` `gu_login` VARBINARY( 99 ) NOT NULL ";
	$result_alter_6 = $sql->query($sql_alter_6) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ;
	...
	$result_alter_7 = $sql->query($sql_alter_7) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ; 
 
	$sql_alter_8=" ALTER TABLE `conges_periode` CHANGE `p_login` `p_login` VARBINARY( 99 ) NOT NULL ";
	$result_alter_8 = $sql->query($sql_alter_8) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ;  

	$sql_alter_9=" ALTER TABLE `conges_solde_user` CHANGE `su_login` `su_login` VARBINARY( 99 ) NOT NULL ";
	$result_alter_9 = $sql->query($sql_alter_9) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ;
	...
	$result_alter_10 = $sql->query($sql_alter_10) or die("erreur : e7_alter_tables_taille_login<br>\n".$sql->error) ;
