...
function saisie() {
	...
	$sql1 = "SELECT p_num, p_login, p_date_deb, p_demi_jour_deb, p_date_fin, p_demi_jour_fin, p_nb_jours, p_commentaire, p_etat, u_login, u_nom, u_prenom, u_solde_jours, u_solde_rtt, u_quotite FROM conges_periode, conges_users WHERE ";
...
//				printf("<td class=\"histo\">%s</td>", $sql_p_etat);
				printf("<td class=\"histo\">$sql_p_etat</td>");
...
//				printf("<td class=\"histo\">%s</td>", affiche_decimal($sql_u_solde_rtt) );
				printf("<td class=\"histo\">$sql_u_solde_rtt</td>");
