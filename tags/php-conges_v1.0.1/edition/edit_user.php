...
<?php
	...
	affichage($user_login, $mysql_link);
...
function affichage($login, $mysql_link)
{
	$PHP_SELF=$_SERVER['PHP_SELF'];
	$session=session_id();
	...
	$ReqLog1 = mysql_query($sql1, $mysql_link) or die("ERREUR : edit_user.php : ".mysql_error());
	...
	affiche_nouvelle_edition($login, $mysql_link);
	
	affiche_anciennes_editions($login, $mysql_link);

}


function affiche_nouvelle_edition($login, $mysql_link)
{
	...
	else
	{
		...
		echo "<tr align=\"center\">\n";
		echo " <td width=\"200\">\n";
			echo "<a href=\"edition.php?session=$session&user_login=$login&edit_id=0\"><img src=\"../img/fileprint_2.png\" width=\"22\" height=\"22\" border=\"0\" title=\"Lancer l'édition\" alt=\"Lancer l'édition\"><b> Lancer l'édition</b></a>\n";
		echo "</td>\n";
		echo " <td width=\"200\">\n";
...
function affiche_anciennes_editions($login, $mysql_link)
{
	$session=session_id();
	...
	else
	{
		...
		while ($resultat2 = mysql_fetch_array($ReqLog2)) 
		{
			...
			$text_edit_a_nouveau="<a href=\"edition.php?session=$session&user_login=$login&edit_id=$sql_id\"><img src=\"../img/fileprint_16x16_2.png\" width=\"16\" height=\"16\" border=\"0\" title=\"Editer à nouveau\" alt=\"Editer à nouveau\"> Editer à nouveau</a>\n";
			$text_edit_pdf_a_nouveau="<a href=\"edition_pdf.php?session=$session&user_login=$login&edit_id=$sql_id\"><img src=\"../img/pdf_16x16_2.png\" width=\"16\" height=\"16\" border=\"0\" title=\"Editer à nouveau en PDF\" alt=\"Editer à nouveau en PDF\"> Editer à nouveau en PDF</a>\n";
