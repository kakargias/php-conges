...
//----------------------------------------------
// si à 0 : le responsable ne reçoit pas de mail lors d'une nouvelle demande de congés par un utilisateur (0 est la valeur par defaut)
// si à 1 : le responsable reçoit un mail d'avertissement à chaque nouvelle demande de congés d'un utilisateur
$config_mail_alerte_resp = 0 ;
...
// si à 1 : gestion jours rtt comme des jours de congés (1 est la valeur par defaut)
