...
function modifier($u_login) {
	...
	$sql1 = "SELECT u_login, u_nom, u_prenom, u_nb_jours_an, u_nb_jours_reste, u_is_resp, u_resp_login, u_passwd FROM conges_users WHERE u_login = '$u_login' " ;
	...
	printf("<tr align=\"center\"><td>login</td><td>Nom</td><td>Prenom</td><td>password1</td><td>password2</td></tr>\n");
	printf("<tr>\n");
