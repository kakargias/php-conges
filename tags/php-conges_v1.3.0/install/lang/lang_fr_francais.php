...
/***********************/
// BOUTONS COMMUNS
$LANG['button_deconnect']	= "Déconnexion";
...
$LANG['form_close_window']	= "Fermer cette Fenêtre";
...
$LANG['resp_traite_user_etat_conges']		= "Etat des congés :";
...
$LANG['admin_button_jours_chomes_1']	= "saisie des jours chômés";
$LANG['admin_button_jours_chomes_2']	= "saisie des jours chômés";
...
$LANG['admin_sauve_db_warning']			= "ATTENTION : toutes les données de la database php_conges vont être écrasées avant la restauration";
...
$LANG['admin_jours_chomes_titre']				= "Saisie des jours chômés";
...
$LANG['msie_alert']				= "Remarque : Certains affichages peuvent ne pas être pris en charge par Microsoft IE. Utilisez plutôt Mozilla Firefox.";
...
$LANG['install_no_prev_version_found']	= "Aucune version antèrieure n'a pu être détermineé";
...
$LANG['install_maj_passer_de']			= "vous êtes sur le point de passer de la version";
...
$LANG['phpmailer_not_valid']	= "ERREUR MAIL : Le fichier class.phpmailer.php ne peut pas être lu ou est introuvable. Le mail d'alerte ne pourra pas être envoyé !";
$LANG['fpdf_not_valid']		= "ERREUR : Le fichier fpdf.php ne peut pas être lu ou est introuvable. Le document PDF ne peut être généré !";
