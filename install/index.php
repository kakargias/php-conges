...
$lang=(isset($_GET['lang']) ? $_GET['lang'] : ((isset($_POST['lang'])) ? $_POST['lang'] : "") ) ;
	...
	elseif(test_config_file($DEBUG)!=TRUE)
	{
...
//		include($lang_file) ;
		...
		echo "<center>\n";
		echo "<br><br>\n";
		echo $_SESSION['lang']['install_le_fichier']." <b>\"config.php\"</b> ".$_SESSION['lang']['install_bad_fichier'].".<br> \n";
		echo $_SESSION['lang']['install_read_the_file']." INSTALL.txt<br>\n";
		echo "<br><a href=\"$PHP_SELF\">".$_SESSION['lang']['install_reload_page']." ....</a><br>\n";
		echo "</center>\n";
		echo "</body>\n</html>\n";
	}
	else
	{
		...
		if(test_database($DEBUG)!=TRUE)
		{
			...
			echo $_SESSION['lang']['install_verifiez_param_file']." config.php .<br>\n";
...
function propose_config($lang, $DEBUG=FALSE)
{
	echo "<html>\n<head>\n";
	echo "<TITLE> PHP_CONGES : Installation : </TITLE>\n</head>\n";
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\" />\n";	
