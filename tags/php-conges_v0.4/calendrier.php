...
<head>
<?php echo "<TITLE> CONGES : Calendrier</TITLE>\n"; ?>
...
<?php
	...
	// GET
	$printable=$HTTP_GET_VARS['printable'];
	$page_initiale=$HTTP_GET_VARS['page_initiale'];
	$year=$HTTP_GET_VARS['year'];
	$mois=$HTTP_GET_VARS['mois'];
	$first_jour=$HTTP_GET_VARS['first_jour'];
	// POST
	/*************************************/
