...
//function affiche_cellule_jour_cal_saisie($login, $j_timestamp, $year, $mois, $jour, $td_second_class, $result)
...
//	$mois_name=date("F", $first_jour_mois_timestamp);
	...
	for($i=$first_jour_mois_rang; $i<8; $i++) {
		...
		//affiche_cellule_jour_cal_saisie($user_login, $j_timestamp, $year, $mois, $j, $td_second_class, "new_debut");
	...
	for($i=8-$first_jour_mois_rang+1; $i<15-$first_jour_mois_rang+1; $i++) {
		...
		//affiche_cellule_jour_cal_saisie($user_login, $j_timestamp, $year, $mois, $i, $td_second_class, "new_debut");
		affiche_cellule_jour_cal_saisie($user_login, $j_timestamp, $td_second_class, "new_debut");
	}
	echo "</tr>\n";
...
//	$mois_name=date("F", $first_jour_mois_timestamp);
	...
	for($i=$first_jour_mois_rang; $i<8; $i++) {
		...
		//affiche_cellule_jour_cal_saisie($user_login, $j_timestamp, $year, $mois, $j, $td_second_class, "new_fin");
	...
	for($i=8-$first_jour_mois_rang+1; $i<15-$first_jour_mois_rang+1; $i++) {
		...
		//affiche_cellule_jour_cal_saisie($user_login, $j_timestamp, $year, $mois, $i, $td_second_class, "new_fin");
		affiche_cellule_jour_cal_saisie($user_login, $j_timestamp, $td_second_class, "new_fin");
	}
	echo "</tr>\n";
...
// affichage de la cellule correspondant au jour dans les calendrier de saisie (demande de conges, etc ...)
//function affiche_cellule_jour_cal_saisie($login, $j_timestamp, $year, $mois, $j, $td_second_class, $result)
function affiche_cellule_jour_cal_saisie($login, $j_timestamp, $td_second_class, $result)
{
global $session;
global $link;
