...
<?php
	...
	$new_nb_j_an=$HTTP_POST_VARS['new_nb_j_an'];
	$new_solde_jours=$HTTP_POST_VARS['new_solde_jours'];
	$new_rtt_an=$HTTP_POST_VARS['new_rtt_an'];
	$new_solde_rtt=$HTTP_POST_VARS['new_solde_rtt'];
...
function modifier($u_login) {
	...
	printf("<tr align=\"center\"><td class=\"histo\">Nom</td><td class=\"histo\">Prenom</td><td class=\"histo\">login</td><td class=\"histo\">Quotité</td><td class=\"histo\">nb congés / an</td><td class=\"histo\">solde congés</td>");
