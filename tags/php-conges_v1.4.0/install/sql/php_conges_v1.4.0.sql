...
CREATE TABLE `conges_artt` (
  `a_login` varbinary(32) NOT NULL default '',
...
CREATE TABLE `conges_echange_rtt` (
  `e_login` varbinary(32) NOT NULL default '',
...
CREATE TABLE `conges_edition_papier` (
  ...
  `ep_login` varbinary(32)  NOT NULL default '',
...
CREATE TABLE `conges_groupe_resp` (
  ...
  `gr_login` varbinary(32) NOT NULL default ''
) TYPE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `conges_groupe_grd_resp` (
  ...
  `ggr_login` varbinary(32) NOT NULL default ''
) TYPE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `conges_groupe_users` (
  ...
  `gu_login` varbinary(32) NOT NULL default ''
) TYPE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `conges_periode` (
  `p_login` varbinary(32) NOT NULL default '',
...
CREATE TABLE `conges_solde_user` (
  `su_login` varbinary(32) NOT NULL default '',
...
`ha_login` varbinary(32) NOT NULL ,
...
CREATE TABLE `conges_logs` (
   ...
   `log_user_login_par` varbinary(32) NOT NULL default '',
   `log_user_login_pour` varbinary(32) NOT NULL default '',
