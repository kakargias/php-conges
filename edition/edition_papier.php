...
$DEBUG = FALSE ;
    ...
    else { edition_year($user_login, $edit_id, $session, $DEBUG); }
...
function head_ed($tab_info_user, $tab_info_edition, $tab_type_cong, $tab_type_conges_exceptionnels, $edit_id, $DEBUG=FALSE)
    {
    ...
    if($edit_id != "0101010")
        ...
        { affiche_tableau_bilan_conges_user_edition_year($tab_info_edition, $DEBUG); }
...
// affichage du tableau récapitulatif des solde de congés d'un user pour l'annee courante !
function affiche_tableau_bilan_conges_user_edition_year($tab_info, $DEBUG=FALSE)
{
...
//  echo "<tr align=\"center\"><td class=\"titre\" colspan=\"3\"> quotité &nbsp; : &nbsp; $quotite % </td></tr>\n" ;
    ...
    echo "  <th> ". _('divers_solde_maj') ."</th>\n";
    echo "  </tr></thead><tbody>\n" ;
    foreach($tab_info['conges'] as $key_type => $v)
    {
        echo "<tr>";
        echo "<td>".$key_type."</td>";
        foreach($v as $under_v)
            {
                echo "<td align=\"center\" bgcolor=\"#FF9191\"><b>".$under_v."</b></td>";
            }
        echo "</tr>\n";
    }
