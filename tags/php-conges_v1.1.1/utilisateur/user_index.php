...
*/
	...
	if($onglet=="changer_mot_de_passe")
	{
		...
		echo "<tr align=\"center\"><td class=\"titre\">".$_SESSION['lang']['user_passwd_saisie_1']."</td><td class=\"titre\">".$_SESSION['lang']['user_passwd_saisie_2']."</td></tr>\n";
...
function affichage_demandes_en_cours($tri_date, $onglet, $mysql_link, $DEBUG=FALSE)
{
	...
	else
	{
		...
		echo "<td class=\"titre\">".$_SESSION['lang']['divers_nb_jours_pris_maj_1']."</td><td class=\"titre\">".$_SESSION['lang']['divers_comment_maj_1']."</td><td></td><td></td></tr>\n" ;
