...
<head>
<?php echo "<TITLE> CONGES : Utilisateur $session_username</TITLE>\n"; ?>
...
<?php
	...
	echo "<td valign=\"middle\">\n";
	echo "<a href=\"$PHP_SELF?session=$session\"><img src=\"../img/reload_page.png\" width=\"22\" height=\"22\" border=\"0\" alt=\"Actualiser la Page\"></a> Actualiser la Page\n";
	echo "</td></tr></table>\n";
...
function affichage($year_calendrier_saisie_debut, $mois_calendrier_saisie_debut, $year_calendrier_saisie_fin, $mois_calendrier_saisie_fin) {
	...
	global $config_auth, $config_user_saisie_demande, $config_user_saisie_mission, $config_user_ch_passwd , $config_verif_droits;
