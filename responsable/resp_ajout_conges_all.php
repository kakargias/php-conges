...
function saisie() {
	...
	printf("<tr align=\"center\"><td>nom</td><td>prenom</td><td>Quotité</td><td>Solde</td><td>NB jours a ajouter</td></tr>\n");
	$cpt_lignes=0 ;
	...
	while ($resultat1 = mysql_fetch_array($ReqLog1)) {
			...
			$champ_saisie=sprintf("<input type=\"text\" name=\"tab_champ_saisie[%s]\" value=\"0\">", $resultat1["u_login"] );
			printf("<td>%s</td><td>%s</td><td>%d%%</td><td>%s</td><td>%s</td>\n", 
