...
<?php 
	...
	if ($config_export_users_from_ldap == TRUE && isset($_POST['new_ldap_user']))
	{
...
function verif_new_param() {
	global $PHP_SELF, $link;
	global $session;
	global $config_rtt_comme_conges, $config_how_to_connect_user, $config_export_users_from_ldap, $config_where_to_find_user_email;
	global $new_login, $new_nom, $new_prenom, $new_quotite, $new_jours_an, $new_solde_jours, $new_rtt_an, $new_solde_rtt ;
	global $new_is_resp, $new_resp_login, $new_is_admin, $new_password1, $new_password2, $new_email ;
	...
	if( ($config_export_users_from_ldap == FALSE &&
		...
		|| ($config_export_users_from_ldap == TRUE &&
...
function affiche_gestion_utilistaeurs()
{
	...
	global $config_rtt_comme_conges, $config_where_to_find_user_email, $config_how_to_connect_user, $config_export_users_from_ldap ;
	global $session;
	global $session_username ;
	global $new_login, $new_nom, $new_prenom, $new_quotite, $new_jours_an, $new_solde_jours, $new_email ;
	...
	echo "<table cellpadding=\"2\" class=\"tablo\" width=\"80%%\">\n";
	echo "<tr align=\"center\">\n";
	if ($config_export_users_from_ldap == TRUE)
